import { Camera, Player, Controls as ControlFactory, Device, Param, Folder, ScriptComponent, Emitter, Events, Components } from '@oo/scripting'


export default class PlayerControls2 extends ScriptComponent{
    ...
    onReady = () => {
        ...
        this.player = Components.byId("player")
    ...
    onStart = () => {
        ...
        //         this.controls.autoAnimate = false;
        //         Player.avatar.stopAll()
        //     }
        // })

        console.log("PlayerControls2 started", this.controls)
    }
